...
After the field has been added to a template, every time a page using that template is saved, content from indexable fields will be automatically stored into the hidden index field.
